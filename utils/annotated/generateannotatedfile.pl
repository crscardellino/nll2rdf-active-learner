...
if (defined $olddir) {
  ...
  $rc = system "perl $directory/getmanualdata.pl $outputdir/data/unannotated.nll2rdf.data $outputdir/instances/tagged $olddir/features >> $outputdir/data/annotated.nll2rdf.data";
